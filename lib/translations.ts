...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    heroEyebrow: "Mountain village eggs",
    heroTitle: "Eggs from the mountains. Naturally limited.",
    heroCopy:
      "Free-roaming chickens. No mass production. Only what nature provides.",
    heroCta: "Get notified",
    heroMeta: "Available in small batches only",
    availabilityToday: "Today",
    availabilityYesterday: "Yesterday",
    availabilityFlock: "Chicken count",
    ...
    howStepOneTitle: "We collect eggs",
    howStepOneDescription: "Fresh eggs are collected in small daily quantities.",
    howStepTwoTitle: "You get notified",
    howStepTwoDescription:
      "When eggs are available, subscribers are informed.",
    howStepThreeTitle: "You reserve",
    howStepThreeDescription: "First come, first served.",
    notifyEyebrow: "Availability updates",
    ...
    footerTagline: "Mountain eggs, naturally raised",
    footerContact: "Contact placeholder",
    footerCopyright: "© 2026 Jajce. All rights reserved.",
  },
  mk: {
    heroEyebrow: "Планински јајца",
    heroTitle: "Јајца од планината. Природно одгледани.",
    heroCopy:
      "Слободно одгледувани кокошки. Без масовно производство. Само тоа што природата го дава.",
    heroCta: "Извести ме",
    heroMeta: "Достапни во мали количини",
    availabilityToday: "Денес",
    availabilityYesterday: "Вчера",
    availabilityFlock: "број на кокошки",
    ...
    howStepOneTitle: "Ги собираме јајцата",
    howStepOneDescription:
      "Свежите јајца се собираат секојдневно, во мали количини.",
    howStepTwoTitle: "Добивате известување",
    howStepTwoDescription:
      "Кога има достапни јајца, претплатниците се известуваат.",
    howStepThreeTitle: "Резервирате",
    howStepThreeDescription: "Кој прв, тој добива.",
    notifyEyebrow: "Известувања за достапност",
    ...
    footerTagline: "Планински јајца, природно одгледани",
    footerContact: "Контакт",
    footerCopyright: "© 2026 Jajce. Сите права се задржани.",
  },
};
